...
class NetWorkUtils {
    ...
    companion object {
         ...
         * 网络类型 - 无连接
         */
        val NETWORK_TYPE_NO_CONNECTION = -1231545315
        ...
        private fun isFastMobileNetwork(context: Context): Boolean {
            val telephonyManager = context.getSystemService(
                    Context.TELEPHONY_SERVICE) as TelephonyManager ?: return false
        ...
        fun isDummyByType(context: Context): Boolean {
            return if (Build.VERSION.SDK_INT < Build.VERSION_CODES.HONEYCOMB_MR2) {
                ...
                getCurrentNetworkType(context) == ConnectivityManager.TYPE_DUMMY
            }
        }
        ...
        fun isEthernetByType(context: Context): Boolean {
            return if (Build.VERSION.SDK_INT < Build.VERSION_CODES.HONEYCOMB_MR2) {
                ...
                getCurrentNetworkType(context) == ConnectivityManager.TYPE_ETHERNET
            }
        }
        ...
        fun isEHRPDBySubtype(context: Context): Boolean {
            return if (Build.VERSION.SDK_INT < Build.VERSION_CODES.HONEYCOMB) {
                ...
                getCurrentNetworkSubtype(context) == TelephonyManager.NETWORK_TYPE_EHRPD
            }
        }
        ...
        fun isEVDO_BBySubtype(context: Context): Boolean {
            return if (Build.VERSION.SDK_INT < Build.VERSION_CODES.GINGERBREAD) {
                ...
                getCurrentNetworkSubtype(context) == TelephonyManager.NETWORK_TYPE_EVDO_B
            }
        }
        ...
        fun isHSPAPBySubtype(context: Context): Boolean {
            return if (Build.VERSION.SDK_INT < Build.VERSION_CODES.HONEYCOMB_MR2) {
                ...
                getCurrentNetworkSubtype(context) == TelephonyManager.NETWORK_TYPE_HSPAP
            }
        }
        ...
        fun isLTEBySubtype(context: Context): Boolean {
            return if (Build.VERSION.SDK_INT < Build.VERSION_CODES.HONEYCOMB) {
                ...
                getCurrentNetworkSubtype(context) == TelephonyManager.NETWORK_TYPE_LTE
            }
        }
        ...
        fun isWifiOpen(context: Context): Boolean {
            ...
            return if (wifiState == WifiManager.WIFI_STATE_ENABLED || wifiState == WifiManager.WIFI_STATE_ENABLING)
                true
            else
                false
        }
        ...
        fun setWifi(context: Context, enable: Boolean): Boolean {
            ...
            if (isWifiOpen(context) != enable) {
                (context.getSystemService(
                        Context.WIFI_SERVICE) as WifiManager).isWifiEnabled = enable
            }
            return true
        }
